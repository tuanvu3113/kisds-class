...
<form method="post" enctype="multipart/form-data">
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'title') ?> (<span class="red">*</span>):</label></div>
                    <div class="col-md-4 col-xs-12 col-sm-12" ><input type="text" class="searchs form-control input-sm" name="title" id="title"/></div>
                </div>
            </div>
...
<script>
    ...
    $(function () {
        $('#solution').multipleSelect({
            filter: true,
            placeholder: '<?= getLanguage('group', 'select_solution') ?>',
            single: true
        });
        refresh();
