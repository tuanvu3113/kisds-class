    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="title" value="<?php echo isset($detail->title)? $detail->title : ''; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'title') ?> (vn) :</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="title_vn" value="<?php echo isset($detail->title_vn) ? $detail->title_vn : ''; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'address') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="address" value="<?php echo $detail->address; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'city') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="city" value="<?php echo $detail->city; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'state') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="state" value="<?php echo $detail->state; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'zip-code') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="zipcode" value="<?php echo $detail->zip_code; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'country') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="country" value="<?php echo $detail->country; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'email-support') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="emailsupport" value="<?php echo $detail->email_support; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'email-sales') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="emailsales" value="<?php echo $detail->email_sales; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'phone-support') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="phonesupport" value="<?php echo $detail->phone_support; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'phone-sales') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="phonesales" value="<?php echo $detail->phone_sales; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm">Fax:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="fax1" value="<?php echo $detail->fax_1; ?>" style="width: 100%;"/></div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm">Google map:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" >
                    <textarea class="form-control" rows="4" id="map" name="map"><?= $detail->map; ?></textarea>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12 col-sm-12" >
                    <textarea class="ckeditor form-control" id="content_vn" name="content_vn"><?php echo isset($detail->content_vn) ? $detail->content_vn : ''; ?></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm"><?= getLanguage('all', 'picture') ?>:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" >
                    ...
                    <div style="margin-top: 2px; height: 250px; border: 1px solid #e5e5e5">
                        <a id="picture-preview" href="<?php echo base_url() . "Images/aboutus/" . $detail->picture; ?>" class="fancybox-button" data-rel="fancybox-button">
                            <img style="max-width: 100%; max-height: 100%;" class="img-responsive" src="<?php echo base_url() . "Images/aboutus/" . $detail->picture; ?>" alt="<?php echo $detail->picture; ?>">
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            if (!empty($detail->json_pictures)) {
                                ...
                                foreach ($arr_pics as $spic) {
                                    $pic = base_url() . "Images/aboutus/detail/" . $spic['name'];
                                    ?>
                                    <tr>
                                        <td>
...
<script>
    ...
    var path_image = '<?php echo base_url() . "Images/aboutus/detail/"; ?>';
    $(function () {
        ...
        $("#save").click(function () {
            ...
            var email_support = $("#emailsupport").val();
            var email_sales = $("#emailsales").val();
            var phone_support = $("#phonesupport").val();
            var phone_sales = $("#phonesales").val();
            var fax_1 = $("#fax1").val();
            var map = $("#map").val();
            ...
            if (valid === 1) {
                ...
                fdata['city'] = city;
                fdata['state'] = state;
                fdata['zip_code'] = zip_code;
                fdata['country'] = country;
                fdata['email_support'] = email_support;
                fdata['email_sales'] = email_sales;
                fdata['phone_support'] = phone_support;
                fdata['phone_sales'] = phone_sales;
                fdata['fax_1'] = fax_1;
                fdata['map'] = map;
                ...
                $.ajax({
                    ...
                    error("<?= getLanguage('all', 'save_fail') ?>");
                });
            } else {
                error(content_error);
            }
