...
class contact_information extends CI_Controller {
    ...
    function mysave() {
        ...
        @rename(FCPATH . "Images/temp/" . $fdata['picture'], FCPATH . "Images/aboutus/" . $fdata['picture']);
    ...
    function upload() {
        ...
        $targetDir = FCPATH . "Images" . DIRECTORY_SEPARATOR . "aboutus" . DIRECTORY_SEPARATOR . "detail";
