 ...
 * @copyright 2015
 */
class list_solution extends CI_Controller {
    ...
    function edit($id) {
        ...
        $data->cat_solution = $this->model->get_category("", 0, "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
    ...
    function ispublish() {
        ...
        $this->model->change_is_publish($id, $status);
    ...
    function mysave() {
        ...
        @rename(FCPATH . "images/temp/" . $fdata['icon'], FCPATH . "images/solution/" . $fdata['icon']);
        @rename(FCPATH . "images/temp/" . $fdata['picture'], FCPATH . "images/solution/" . $fdata['picture']);
        @rename(FCPATH . "images/temp/" . $fdata['picture_mobile'], FCPATH . "images/solution/" . $fdata['picture_mobile']);
    ...
    function uploadFile() {
        if (isset($_FILES['file']) && $_FILES['file']['name'] != "") {
            ...
            /*
             * check picture size
              if ($size_pic[0] == 1340 || $size_pic[1] == 1006) {
              $rs["status"] = "pass";
              echo json_encode($rs);
              } else {
              $rs["status"] = "size";
    ...
    function upload() {
        ...
        $targetDir = FCPATH . "images" . DIRECTORY_SEPARATOR . "solution";
