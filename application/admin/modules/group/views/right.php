...
<ul class="button-group pull-right" style="margin-right:0px; margin-top:6px;">
	<li id="cancel"><button class="button" style="height: 26px; padding: 2px 10px;"><?=getLanguage('all','cancel');?></button></li>
	<li id="saveright"><button class="button" style="height: 26px; padding: 2px 10px;"><?=getLanguage('all','save');?></button></li>
</ul>
<style type="text/css">
