 ...
 * @copyright 2015
 */
class home_public extends CI_Controller {
    ...
    function edit($id) {
        ...
        $data->solutions = $this->model->getSolutions();
    ...
    function mysave() {
        ...
        @rename(FCPATH . "Images/temp/" . $fdata['picture'], FCPATH . "Images/public/" . $fdata['picture']);
        @rename(FCPATH . "Images/temp/" . $fdata['picture_mobile'], FCPATH . "Images/public/" . $fdata['picture_mobile']);
    ...
    function upload() {
        ...
        $targetDir = FCPATH . "Images" . DIRECTORY_SEPARATOR . "public" . DIRECTORY_SEPARATOR . "detail";
