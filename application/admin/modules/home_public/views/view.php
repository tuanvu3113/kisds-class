        ...
        <div class="portlet-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-5 col-xs-9 col-sm-9" ><input type="text" class="searchs form-control input-sm" name="title" id="title"/></div>
                    <div class="col-md-1 col-xs-3 col-sm-3 text-right"><label class="control-label-sm" style="text-transform: capitalize;">Menu:</label></div>
