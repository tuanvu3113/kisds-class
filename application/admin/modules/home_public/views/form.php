    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12 col-sm-12" ><input type="text" class="form-control input-sm" id="title_vn" value="<?php echo $detail->title; ?>" style="width: 100%;"/></div>
            </div>
           <!--  <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-xs-12 col-sm-12">
                    <select id="area" class="form-control input-sm">
                        <option value='1' <?php echo ($detail->area == 1) ? "selected" : ""; ?>>Giới thiệu</option>
                        <option value='2' <?php echo ($detail->area == 2) ? "selected" : ""; ?>>Tuyển dụng</option>
                        <option value='3' <?php echo ($detail->area == 3) ? "selected" : ""; ?>>Hoạt động</option>
                    </select>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12 col-sm-12" >
                    <textarea class="ckeditor form-control" id="content_vn" name="content"><?= $detail->content; ?></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 col-xs-12 col-sm-12"><label class="control-label-sm">Picture:</label></div>
                <div class="col-md-10 col-xs-12 col-sm-12" >
                    ...
                    <div style="margin-top: 2px; height: 250px; border: 1px solid #e5e5e5">
                        <a id="picture-preview" href="<?php echo base_url() . "Images/public/" . $detail->picture; ?>" class="fancybox-button" data-rel="fancybox-button">
                            <img style="max-width: 100%; max-height: 100%;" class="img-responsive" src="<?php echo base_url() . "Images/public/" . $detail->picture; ?>" alt="<?php echo $detail->picture; ?>">
                        </a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12 col-sm-12" >
                    ...
                    <div style="margin-top: 2px; height: 250px; border: 1px solid #e5e5e5">
                        <a id="picture-mobile-preview" href="<?php echo base_url() . "Images/public/" . $detail->picture_mobile; ?>" class="fancybox-button" data-rel="fancybox-button">
                            <img style="max-width: 100%; max-height: 100%;" class="img-responsive" src="<?php echo base_url() . "Images/public/" . $detail->picture_mobile; ?>" alt="<?php echo $detail->picture_mobile; ?>">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-hover" id="tbl_img">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th class="text-center" width="40%">Label</th>
                                <th class="text-center" width="28%">Link</th>
                                <th class="text-center" width="7%">Show</th>
                                <th class="text-center" width="10%">Function</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if (!empty($detail->json_pictures)) {
                                ...
                                foreach ($arr_pics as $spic) {
                                    $pic = base_url() . "Images/public/detail/" . $spic['name'];
                                    ?>
                                    <tr>
                                        <td>
...
<script>
    ...
    var path_image = '<?php echo base_url() . "Images/public/detail/"; ?>';
    $(function () {
        ...
        $("#save").click(function () {
            ...
            if (title.length === 0) {
                content_error = "Title is not empty";
            }
            // else if (link === "") {
            //     content_error = "Link is not empty";
            // }
            else if (label === "") {
                content_error = "Label is not empty";
            } else if (content === "") {
                content_error = "Content is not empty";
            } else if (picture === "") {
                content_error = "The picture has not been selected or size mismatch (1340x1006)";
            } else if (pictures.length === 0) {
                content_error = "List image is not empty";
            } else if (area.length === 0) {
                content_error = "Menu is not empty";
            } else {
                valid = 1;
            }
            if (valid === 1) {
