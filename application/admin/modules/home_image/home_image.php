...
class home_image extends CI_Controller {
    ...
    function _view() {
        ...
        $_SESSION["title"]= 'Thông tin trang chủ';
    ...
    function mysave() {
        ...
        @rename(FCPATH . "Images/temp/" . $fdata['picture'], FCPATH . "Images/home/" . $fdata['picture']);
        @rename(FCPATH . "Images/temp/" . $fdata['picture_mobile'], FCPATH . "Images/home/" . $fdata['picture_mobile']);
    ...
    function upload() {
        ...
        $targetDir = FCPATH . "Images" . DIRECTORY_SEPARATOR . "home" . DIRECTORY_SEPARATOR . "detail";
