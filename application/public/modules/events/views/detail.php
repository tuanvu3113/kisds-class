 ...
 <div class="content-wrap">
     ...
     <div class="row">
       ...
       <div class="col-sm-12 col-md-12 col-lg-9">
         <div class="single-news">
            <img src="/images/dummy-img-900x600.jpg" alt="" class="img-fluid rounded"> 
           <div class="spacer-30"></div>

           <h2 class="title"> English Day on Carfree day </h2> 
  ...
  <div class="col-sm-12 col-md-12 col-lg-3">
   <div class="events-widget">
     <div class="widget-title">Venue</div>
     <dl>
    ...
    <div class="widget-title">Organizer</div>
    <dl>
       <dt>Max Organizer</dt>
       <dt>Phone:</dt>
       <dd>074574217447</dd>
