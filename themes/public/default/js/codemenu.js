...
ssmItems[0]=["Send/Receive status message"] //create header
ssmItems[1];//=["Send/Receive status message"] //create header
function truebody(){
...
if (NS) 
{
	document.write('<layer name="basessm1" top="'+YOffset+'" left='+XOffset+' visibility="show"><ilayer name="basessm2"><layer visibility="hide" name="thessm" id="thessm" bgcolor="'+menuBGColor+'" left="'+(-menuWidth)+'" onmouseover="moveOut()" onmouseout="moveBack()">')
}
if (NS6)
{
...
theleft=-menuWidth;lastY=0;setTimeout('initSlide();', 10)}
