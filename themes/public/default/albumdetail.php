	...
	<div id="main">
		...
		<header id="header">
					...
					<h1 class="text-center">
						<a class="" href="<?=base_url();?>album"><img src="<?=base_url();?>img/logo_final.png" alt="logo" style="width:60px; margin-top:-5px;"></a>
					</h1>
				...
				<footer id="footer">
					<ul class="copyright text-center">
						<li>&copy; Click</li>
						<li>Copyright 2017 ĐBT. All rights reserved.</li>
